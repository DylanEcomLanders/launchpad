...
const seedChangelog: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: "added", text: "Member vs Admin access levels. Members (team role) now see Delivery (the kanban board) alongside My Tasks, Hero Offer, Training and tools - so fulfilment/delivery people like Alister aren't locked out. Admins keep everything (Onboarding, Old Delivery, KPIs, Sales, Retention, Finance, Admin). Set someone's level on the Team Access page (⌘K → 'team access') or right on their Person page when you set login credentials (Member / Admin toggle). Role changes apply on the person's next sign-in. Backed by a service-role /api/admin/set-user-role endpoint so RLS doesn't block it" },
