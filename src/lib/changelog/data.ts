...
const seedChangelog: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: "improved", text: "Cover→slide-2 transition tightened. The exiting cover overlay now fades out via a 360ms cover-exit-fade animation instead of staying fully opaque for the entire 520ms cross-fade window. No more cover content visually persisting over the new slide" },
