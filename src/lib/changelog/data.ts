...
const seedChangelog: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: "improved", text: "Portal admin layout — horizontal top tabs when drilled into a project (matches client portal), Client Settings as collapsible section in Overview" },
      ...
      { type: "improved", text: "Client Settings moved from sidebar to collapsible section in Overview — team, Slack channels, touchpoint info grouped under expandable panel" },
