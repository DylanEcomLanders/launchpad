...
export const DEV_HANDOFF_ITEMS = [
  ...
  "JS files: el-[name]-init.js (functionality) or el-utils-[name].js (utility)",
  // ── 2.1 File Template (4) ──
  ...
  "Desktop and mobile spacing settings provided separately — mobile defaults roughly 50% of desktop",
  ...
  // ── 4.2 CSS (4) ──
  "Class names follow BEM methodology with el- prefix — no mixed naming conventions in the same file",
...
export const DEV_HANDOFF_CATEGORIES: GateCategory[] = [
  { label: "0.1 — Visual", startIndex: 0, count: 4 },
  { label: "0.2 — Scrolling & Navigation", startIndex: 4, count: 4 },
  { label: "0.3 — Interactions", startIndex: 8, count: 5 },
  { label: "0.4 — Buying Flow", startIndex: 13, count: 3 },
  { label: "0.5 — Edge Cases", startIndex: 16, count: 2 },
  { label: "0.6 — Client Editability", startIndex: 18, count: 3 },
  { label: "1.1 — Agency Prefix & Naming", startIndex: 21, count: 3 },
  { label: "1.2 — Snippet & Asset Naming", startIndex: 24, count: 3 },
  { label: "2.1 — File Template", startIndex: 27, count: 4 },
  { label: "2.2 — File Length", startIndex: 31, count: 3 },
  { label: "3.1 — Setting Labels & Info", startIndex: 34, count: 4 },
  { label: "3.2 — Setting Organisation", startIndex: 38, count: 5 },
  { label: "3.3 — Client Experience", startIndex: 43, count: 3 },
  { label: "4.1 — Liquid", startIndex: 46, count: 4 },
  { label: "4.2 — CSS", startIndex: 50, count: 4 },
  { label: "4.3 — JavaScript", startIndex: 54, count: 3 },
  { label: "5.1 — Shopify Image Tags", startIndex: 57, count: 6 },
  { label: "5.2 — Image Quality", startIndex: 63, count: 3 },
  { label: "5.3 — Alt Text", startIndex: 66, count: 2 },
  { label: "5.4 — Video & Embeds", startIndex: 68, count: 3 },
  { label: "6.1 — Figma Match", startIndex: 71, count: 5 },
  { label: "6.2 — Typography", startIndex: 76, count: 3 },
  { label: "6.3 — Colours & Visual", startIndex: 79, count: 4 },
  { label: "7.1 — Desktop", startIndex: 83, count: 2 },
  { label: "7.2 — Tablet", startIndex: 85, count: 3 },
  { label: "7.3 — Mobile", startIndex: 88, count: 5 },
  { label: "7.4 — Cross-Browser", startIndex: 93, count: 2 },
  { label: "8 — Navigation & Links", startIndex: 95, count: 3 },
  { label: "9 — PDP Functionality", startIndex: 98, count: 5 },
  { label: "10 — Cart & Checkout", startIndex: 103, count: 4 },
  { label: "11 — Subscriptions", startIndex: 107, count: 4 },
  { label: "12 — Multi-Currency", startIndex: 111, count: 5 },
  { label: "13 — Forms", startIndex: 116, count: 6 },
  { label: "14.1 — Performance Benchmarks", startIndex: 122, count: 4 },
  { label: "14.2 — Scripts & Assets", startIndex: 126, count: 3 },
  { label: "14.3 — Console", startIndex: 129, count: 3 },
  { label: "15 — Accessibility", startIndex: 132, count: 6 },
  { label: "16 — Content & Copy", startIndex: 138, count: 3 },
  { label: "17.1 — Theme Safety", startIndex: 141, count: 4 },
  { label: "17.2 — Migration to Live", startIndex: 145, count: 4 },
];
