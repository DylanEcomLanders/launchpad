...
export const DEV_HANDOFF_CATEGORIES: GateCategory[] = [
  ...
  { label: "4. Buying Flow", startIndex: 13, count: 3 },
  { label: "5. Edge Cases", startIndex: 16, count: 2 },
  { label: "6. Client Editability", startIndex: 18, count: 3 },
  { label: "7. Agency Prefix & Naming", startIndex: 21, count: 3 },
  { label: "8. Snippet & Asset Naming", startIndex: 24, count: 3 },
  { label: "9. File Template", startIndex: 27, count: 4 },
  { label: "10. File Length", startIndex: 31, count: 3 },
  { label: "11. Setting Labels & Info", startIndex: 34, count: 4 },
  { label: "12. Setting Organisation", startIndex: 38, count: 5 },
  { label: "13. Client Experience", startIndex: 43, count: 3 },
  { label: "14. Liquid", startIndex: 46, count: 4 },
  { label: "15. CSS", startIndex: 50, count: 4 },
  { label: "16. JavaScript", startIndex: 54, count: 3 },
  { label: "17. Shopify Image Tags", startIndex: 57, count: 6 },
  { label: "18. Image Quality", startIndex: 63, count: 3 },
  { label: "19. Alt Text", startIndex: 66, count: 2 },
  { label: "20. Video & Embeds", startIndex: 68, count: 3 },
  { label: "21. Figma Match", startIndex: 71, count: 5 },
  { label: "22. Typography", startIndex: 76, count: 3 },
  { label: "23. Colours & Visual", startIndex: 79, count: 4 },
  { label: "24. Desktop", startIndex: 83, count: 2 },
  { label: "25. Tablet", startIndex: 85, count: 3 },
  { label: "26. Mobile", startIndex: 88, count: 5 },
  { label: "27. Cross-Browser", startIndex: 93, count: 2 },
  { label: "28. Navigation & Links", startIndex: 95, count: 3 },
  { label: "29. PDP Functionality", startIndex: 98, count: 5 },
  { label: "30. Cart & Checkout", startIndex: 103, count: 4 },
  { label: "31. Subscriptions", startIndex: 107, count: 4 },
  { label: "32. Multi-Currency", startIndex: 111, count: 5 },
  { label: "33. Forms", startIndex: 116, count: 6 },
  { label: "34. Performance Benchmarks", startIndex: 122, count: 4 },
  { label: "35. Scripts & Assets", startIndex: 126, count: 3 },
  { label: "36. Console", startIndex: 129, count: 3 },
  { label: "37. Accessibility", startIndex: 132, count: 6 },
  { label: "38. Content & Copy", startIndex: 138, count: 3 },
  { label: "39. Theme Safety", startIndex: 141, count: 4 },
  { label: "40. Migration to Live", startIndex: 145, count: 4 },
];
