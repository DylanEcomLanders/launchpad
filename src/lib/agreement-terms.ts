...
/* ── Background & Consideration (dynamic preamble on Parties page) ── */

export const backgroundClauses = [
  "The Client is of the opinion that the Contractor has the necessary qualifications, experience and abilities to provide services to the Client.",
  "The Contractor is agreeable to providing such services to the Client on the terms and conditions set out in this Agreement.",
];

export const considerationText =
  "IN CONSIDERATION OF the matters described above and of the mutual benefits and obligations set forth in this Agreement, the receipt and sufficiency of which consideration is hereby acknowledged, the Client and the Contractor (individually the \"Party\" and collectively the \"Parties\" to this Agreement) agree as follows:";

/* ── Standard Terms (numbered clauses matching the real template) ── */
...
export const standardTerms = [
  ...
  {
    heading: "Capacity / Independent Contractor",
    clauses: [
  ...
  {
    heading: "Right of Substitution",
    clauses: [
      "Except as otherwise provided in this Agreement, the Contractor may, at the Contractor's absolute discretion, engage a third party sub-contractor to perform some or all of the obligations of the Contractor under this Agreement and the Client will not hire or engage any third parties to assist with the provision of the Services.",
      "In the event that the Contractor hires a sub-contractor: the Contractor will pay the sub-contractor for its services and the Payment will remain payable by the Client to the Contractor; and for the purposes of the indemnification clause of this Agreement, the sub-contractor is an agent of the Contractor.",
    ],
  },
  {
    heading: "Autonomy",
