  ...
  return (
    <div className="p-6 md:p-10 max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="px-4 py-2 border border-foreground text-foreground text-sm font-semibold rounded-lg hover:bg-surface-raised transition-colors"
          >
            Showcase page
          </Link>
          <button
      ...
      {loading ? (
        ...
        <div className="bg-white border border-border rounded-xl shadow-[var(--shadow-soft)] overflow-hidden">
          <table className="w-full text-sm">
            ...
            <tbody>
              {studies.map((s) => (
                <tr key={s.id} className="border-b border-surface-raised last:border-0 hover:bg-surface-raised">
                  <td className="px-5 py-3">
                    ...
                    <div className="text-[10px] text-muted font-mono mt-0.5">/{s.slug}</div>
                  </td>
                  ...
                  <td className="px-5 py-3">
                    {s.settings.published ? (
                      ...
                      <span className="text-[10px] font-semibold uppercase tracking-wider px-2 py-1 bg-surface-raised text-subtle rounded-full">
                        Draft
                      </span>
                    )}
                  </td>
                  ...
                  <td className="px-5 py-3">
                    <div className="flex items-center justify-end gap-1">
                      <Link
                        href={`/case-studies/${s.slug}/edit`}
                        className="p-1.5 text-subtle hover:text-foreground hover:bg-surface-raised rounded transition-colors"
                        title="Edit"
                      >
                      ...
                      <button
                        ...
                        className="p-1.5 text-subtle hover:text-red-600 hover:bg-red-50 rounded transition-colors"
                        title="Delete"
                      >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
            <div className="bg-white rounded-2xl w-full max-w-md shadow-xl">
              <div className="border-b border-border px-6 py-4 flex items-center justify-between">
                <h2 className="font-semibold text-foreground">New case study</h2>
                <button
              ...
              <form onSubmit={handleCreate} className="p-6 space-y-4">
                ...
                <div className="flex justify-end gap-2 pt-2">
                  <button
                    type="button"
                    onClick={() => setModalOpen(false)}
                    className="px-4 py-2 text-sm border border-foreground rounded-lg hover:bg-[#F5F5F7]"
                  >
                    Cancel
                  </button>
                  <button
