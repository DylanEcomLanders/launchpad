...
export function WorkspaceNav() {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-slate-200/70 bg-[#FBFBFD]/85 backdrop-blur">
      <div className="mx-auto flex max-w-[1240px] items-center gap-6 px-6">
        ...
        {me && (
          <div className="ml-auto flex items-center gap-2 py-4 text-xs text-slate-500">
