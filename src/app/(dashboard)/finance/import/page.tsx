  ...
  return (
    <div className="max-w-3xl space-y-8">
      ...
      <ImportSection
        ...
        icon={<UsersIcon className="size-5 text-[#7A7A7A]" />}
      ...
      <ImportSection
        ...
        icon={<DocumentTextIcon className="size-5 text-[#7A7A7A]" />}
    ...
    <div className="bg-white border border-[#E5E5EA] rounded-xl p-5 shadow-[var(--shadow-soft)]">
      <div className="flex items-start gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-[12px] text-[#7A7A7A] mt-0.5">{subtitle}</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <input
          ...
          className="block w-full text-sm text-[#1B1B1B] file:mr-3 file:py-1.5 file:px-3 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-[#1B1B1B] file:text-white hover:file:opacity-90"
        />
        {file && (
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-4 py-2 bg-[#1B1B1B] text-white text-sm font-medium rounded-md hover:opacity-90 disabled:opacity-40"
        >
          {importing ? (
        ...
        <details className="text-xs text-[#7A7A7A]">
          ...
          <code className="block bg-[#F7F8FA] px-3 py-2 rounded text-[10px] mt-2 overflow-x-auto">
            {headerReference}
          </code>
        </details>
      </div>
