    ...
    return (
      <div className="relative min-h-screen">
        ...
        <div className="relative z-10 flex items-center justify-center py-32">
          <ArrowPathIcon className="size-6 animate-spin text-subtle" />
        </div>
      </div>
    );
  }
              ...
              {pbs.map((pb) => {
                ...
                return (
                  <div
                    ...
                    className="group relative bg-surface-raised border border-border rounded-lg p-5 text-left transition-all duration-200 hover:border-muted hover:bg-border cursor-pointer"
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 text-[10px] font-semibold uppercase tracking-wider text-subtle">
          ...
          <div className="text-center py-16">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <button
                ...
                className="px-6 py-2.5 border border-border bg-surface text-subtle text-sm font-medium rounded-md hover:bg-surface-raised transition-colors"
              >
                Retake
              </button>
            </div>
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 md:px-12 py-12 md:py-16">
        ...
        {step.quiz && (
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              <LockClosedIcon className="size-4 text-subtle" />
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2.5 text-sm text-subtle hover:text-foreground disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
          >
...
function MarkdownRenderer({ content }: { content: string }) {
  const html = content
    ...
    .replace(/\*(.*?)\*/g, "<em>$1</em>")
    .replace(/^- (.*$)/gm, '<li class="ml-4 list-disc text-sm leading-relaxed text-subtle">$1</li>')
    .replace(/^\d+\. (.*$)/gm, '<li class="ml-4 list-decimal text-sm leading-relaxed text-subtle">$1</li>')
    .replace(/\n\n/g, '</p><p class="text-sm leading-relaxed mb-3 text-subtle">')
    .replace(/\n/g, "<br/>");

  return (
    <div
      dangerouslySetInnerHTML={{
        __html: `<p class="text-sm leading-relaxed mb-3 text-subtle">${html}</p>`,
      }}
    />
  );
}
