            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="inline-flex rounded-md border border-[#E5E5E5] overflow-hidden w-full">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              {uniqueCategories.length > 0 && (
                <select
                  ...
                  className="px-3 py-2 bg-white border border-[#E5E5E5] rounded-md text-xs focus:outline-none focus:border-[#0A0A0A] transition-colors"
                >
              ...
              {(filterStatus !== "all" || filterCategory) && (
                <button
                  ...
                  className="text-xs text-[#AAAAAA] hover:text-[#0A0A0A] transition-colors"
                >
                  Clear filters
                </button>
              )}
          ...
          <section>
            ...
            {loading ? (
              ...
              <div className="bg-[#F5F5F5] border border-[#E5E5E5] rounded-lg overflow-hidden">
                {/* Desktop header */}
                <div className="hidden md:grid grid-cols-[1fr_100px_90px_80px_80px_32px] gap-3 px-4 py-2.5 border-b border-[#E5E5E5] bg-[#F0F0F0]">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="hidden md:grid grid-cols-[1fr_100px_90px_80px_80px_32px] gap-3 items-center">
                          ...
                          <span className="text-xs text-[#6B6B6B] text-center capitalize">
                            {expense.frequency}
                          </span>
                          <button
