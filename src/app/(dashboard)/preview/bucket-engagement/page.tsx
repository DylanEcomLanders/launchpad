    ...
    <div className="mx-auto max-w-6xl px-6 py-6">
      ...
      <div className="mt-6 rounded-lg border border-border bg-background p-4 text-xs text-subtle">
        ...
        <ul className="mt-1 list-disc space-y-0.5 pl-4">
          <li>
            <span className="font-medium text-foreground">No cycle tabs.</span> Single flat deliverable view. Bucket runs end-to-end, ships by day 15.
          </li>
          <li>
            <span className="font-medium text-foreground">Strategy is front-loaded.</span> One big brief upfront (already done), then design reviews and QAs per deliverable. No recurring monthly reviews, no roadmap thinking.
          </li>
          <li>
            <span className="font-medium text-foreground">Sandbox is lighter</span> by nature, fewer resources accumulate over 15 working days than 90. Same shape, less content.
          </li>
          <li>
            <span className="font-medium text-foreground">Pattern is identical to CE.</span> Strategy/Design/Dev deliverable lists, sandbox section, generate branded button. The strategist doesn't have to learn two surfaces.
          </li>
        </ul>
      </div>
    </div>
