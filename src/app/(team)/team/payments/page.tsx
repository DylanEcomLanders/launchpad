    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-12 py-12 md:py-16">
        ...
        <div className="mb-12 pb-8 border-b border-border">
          <div className="flex items-center justify-between mb-6 font-mono text-[10px] uppercase tracking-[0.16em] text-subtle">
        ...
        <Section num="03 / Per-role fees" tag="What each role earns per page" title="What each role earns per page.">
          ...
          <div className="border border-border rounded-lg overflow-hidden">
            <div className="grid grid-cols-[100px_repeat(4,1fr)_110px] md:grid-cols-[140px_repeat(4,1fr)_120px] gap-3 px-5 py-3 bg-surface-raised text-foreground font-mono text-[9px] md:text-[10px] uppercase tracking-[0.12em] font-semibold items-center">
              <div>Tier</div>
            ...
            {fees.map((f, i) => (
              <div
                key={f.tier}
                className={`grid grid-cols-[100px_repeat(4,1fr)_110px] md:grid-cols-[140px_repeat(4,1fr)_120px] gap-3 px-5 py-4 items-center text-sm md:text-base text-foreground ${
              ...
              >
                ...
                <div className="text-right font-bold text-foreground">£{f.total}</div>
              </div>
            ))}
          </div>
        </Section>
                  ...
                  {ex.rows.map((r, i) => (
                    <div
                      ...
                      className={`flex justify-between items-baseline px-3 py-2 text-xs ${
                        ex.rebate ? "bg-background" : "bg-surface"
                      } ${i < ex.rows.length - 1 ? "border-b border-border" : ""}`}
                    >
                      <span className="font-mono text-[9px] uppercase tracking-[0.1em] text-subtle">{r.label}</span>
                      <span className="text-sm font-semibold text-foreground">{r.value}</span>
                    </div>
                  ))}
                </div>
                <div className="font-mono text-[9px] uppercase tracking-[0.12em] text-subtle text-right mt-2">
                  Team total · {ex.total}
                </div>
              </div>
            ))}
        ...
        <Section num="06 / Rush fee" tag="What happens on compressed projects" title="The rush fee.">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-surface-raised border border-border rounded-lg overflow-hidden">
            <div className="bg-surface p-6 flex flex-col gap-3">
              <div className="font-mono text-[10px] uppercase tracking-[0.16em] text-subtle">Standard project</div>
        ...
        <Section num="07 / Retainers" tag="How Conversion Partnership clients work" title="How retainer pay works.">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-surface-raised border border-border rounded-lg overflow-hidden">
            <div className="bg-surface p-6">
              <div className="font-mono text-[18px] font-bold text-foreground leading-none mb-3">✓ Pays</div>
            ...
            <div className="bg-background p-6">
              <div className="font-mono text-[18px] font-bold text-subtle leading-none mb-3">✕ Doesn&apos;t pay</div>
              <div className="text-base font-bold text-foreground mb-2">
        ...
        <Section num="08 / How and when" tag="Invoicing and payment" title="Invoicing and payment.">
          ...
          <Link
            href="/me/invoices"
            className="mt-5 flex items-center justify-between gap-4 p-5 rounded-lg bg-surface-raised text-foreground hover:bg-border transition-colors group"
          >
  ...
  return (
    <section className="mb-16">
      <div className="flex items-baseline gap-5 mb-5">
        <div className="font-mono text-[11px] uppercase tracking-[0.18em] text-foreground font-semibold">{num}</div>
        <div className="font-mono text-[10px] uppercase tracking-[0.16em] text-subtle">{tag}</div>
      </div>
