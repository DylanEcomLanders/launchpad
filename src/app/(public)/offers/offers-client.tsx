    ...
    <div className="min-h-screen bg-surface-raised flex flex-col">
      ...
      <section className="bg-surface text-white relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-6 md:px-10 pt-24 pb-20 md:pt-36 md:pb-28 text-center relative">
          ...
          >
            Same ad spend.{" "}
            <span className="bg-[#D1FF4C] text-foreground px-2 py-0.5 rounded">
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-4 bg-[#D1FF4C] text-foreground text-sm font-semibold rounded-full hover:bg-[#C5F441] transition-colors"
            >
          ...
          <div className="mt-14 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-xs uppercase tracking-[0.16em] text-subtle">
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-10 py-20 md:py-28">
          <div className="text-center mb-12 md:mb-16">
            ...
            >
              ...
              <br />
              <span className="text-subtle">money walks out the door.</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/[0.06] rounded-2xl overflow-hidden border border-white/[0.06]">
            <div className="bg-background p-8 md:p-10">
              ...
              <p className="text-3xl md:text-4xl font-semibold tracking-tight mt-6 tabular-nums">
                £148,500<span className="text-base text-subtle font-normal">/mo</span>
              </p>
              <p className="text-xs text-subtle mt-2">Today's revenue</p>
            </div>
            <div className="bg-background p-8 md:p-10">
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-subtle mb-3">
                Industry benchmark
              ...
              <p className="text-3xl md:text-4xl font-semibold tracking-tight mt-6 tabular-nums">
                £264,000<span className="text-base text-subtle font-normal">/mo</span>
              </p>
              <p className="text-xs text-subtle mt-2">If they hit benchmark</p>
            </div>
            <div className="bg-[#D1FF4C] text-foreground p-8 md:p-10">
      ...
      <section className="bg-white border-y border-border">
        <div className="max-w-5xl mx-auto px-6 md:px-10 py-20 md:py-28">
          <div className="text-center mb-14 md:mb-20">
            ...
            <h2
              className="text-3xl md:text-5xl font-semibold tracking-tight leading-[1.1] text-foreground max-w-3xl mx-auto"
              style={{ fontFamily: "var(--font-heading)" }}
            >
              You don't brief us.
              <br />
              <span className="text-subtle">We own the roadmap.</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-border rounded-2xl overflow-hidden border border-border">
            <div className="bg-white p-8 md:p-10">
              ...
              <p className="text-base text-subtle leading-[1.55]">
      ...
      <section className="bg-surface-raised">
        <div className="max-w-5xl mx-auto px-6 md:px-10 py-20 md:py-28">
          <div className="text-center mb-14 md:mb-20">
            ...
            <h2
              className="text-3xl md:text-5xl font-semibold tracking-tight leading-[1.1] text-foreground"
              style={{ fontFamily: "var(--font-heading)" }}
            >
              Quick wins fast.
              <br />
              <span className="text-subtle">Compounding from Month 3.</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              >
                ...
                <h3
                  className="text-xl font-semibold text-foreground tracking-tight leading-[1.2]"
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  {step.title}
                </h3>
                <p className="text-[15px] text-subtle leading-[1.55] mt-4">{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10 py-20 md:py-28">
          <div className="text-center mb-14 md:mb-20">
            ...
            >
              3,500+ pages shipped.
              <br />
              <span className="text-subtle">Here's what they moved.</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-px bg-white/[0.06] rounded-2xl overflow-hidden border border-white/[0.06]">
            {[
              ...
              <div key={item.vert} className="bg-surface p-6 md:p-8">
                ...
                <p className="text-xs text-subtle mt-3 leading-[1.4]">{item.note}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-10 py-20 md:py-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-14">
            {ENGINE_INCLUDES.map((col) => (
              <div key={col.group}>
                <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-foreground mb-5 pb-4 border-b border-border">
                  {col.group}
                </p>
                <ul className="space-y-4">
                  {col.items.map((item) => (
                    <li
                      key={item}
                      className="text-base text-subtle leading-[1.5]"
                    >
                      {item}
                    </li>
                  ))}
          ...
          <div className="mt-16 md:mt-20 text-center">
            ...
            <p className="text-xs text-subtle mt-5 uppercase tracking-[0.16em]">
      ...
      <section className="bg-surface-raised">
        <div className="max-w-6xl mx-auto px-6 md:px-10 py-20 md:py-32">
          <div className="text-center mb-14 md:mb-20">
            ...
            <p
              className="text-base md:text-lg text-subtle leading-[1.6] mt-5 max-w-xl mx-auto"
              style={{ fontFamily: "var(--font-body)" }}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {funnelBuilds.map((build) => (
              ...
              >
                ...
                <p className="text-base text-subtle mt-3 leading-[1.5]">{build.positioning}</p>

                <ul className="mt-8 space-y-3.5 text-[15px] text-subtle flex-1">
      ...
      {portfolioImages.length > 0 && (
        <section className="bg-white border-t border-border py-20 md:py-28">
          <div className="max-w-6xl mx-auto px-6 md:px-10 mb-12 md:mb-16 text-center">
            ...
            <Link
              href="/portfolio-v2"
              className="inline-block mt-6 text-sm font-semibold text-foreground hover:underline"
            >
              See full portfolio →
            </Link>
          </div>
            ...
            <div className="flex gap-6 animate-scroll-offers">
              {[...portfolioImages, ...portfolioImages].map((src, idx) => (
                <img
                  ...
                  width={240}
                  height={360}
                  className="shrink-0 w-[240px] h-[360px] object-cover rounded-xl border border-border"
                />
              ))}
            </div>
          </div>
      ...
      <section className="bg-surface-raised border-t border-border">
        <div className="max-w-3xl mx-auto px-6 md:px-10 py-24 md:py-36 text-center">
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-subtle mb-5">
            Not sure which fits?
          </p>
          <h3
            className="text-3xl md:text-5xl font-semibold tracking-tight text-foreground leading-[1.1]"
            style={{ fontFamily: "var(--font-heading)" }}
          >
            Book a discovery call.
          </h3>
          <p className="text-base md:text-lg text-subtle mt-6 leading-[1.6] max-w-xl mx-auto">
