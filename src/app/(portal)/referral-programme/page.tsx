...
function ReferralProgrammeInner() {
  ...
  return (
    <div className="min-h-screen relative">
        ...
        <div className="fixed top-4 right-4 z-50 flex items-center gap-2">
          ...
          <button
            ...
            className={`px-4 py-1.5 text-[11px] font-medium rounded-lg shadow-sm transition-colors ${
              saved ? "bg-[#4ADE80] text-white" : editing ? "bg-[#080808] text-white hover:bg-[#1A1A1A]" : "bg-white text-[#AAA] border border-[#E5E5EA]"
            }`}
          >
      ...
      {/* ── Hero (Dark) ── */}
      <section className="bg-[#080808] text-white px-6 py-20 md:py-28">
      ...
      {/* ── How It Works (Dark) ── */}
      <section className="bg-[#080808] text-white px-6 py-16 md:py-20">
        <div className="max-w-2xl mx-auto">
      ...
      <section className="bg-white px-6 py-20 md:py-28">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <a href={content.whatsappUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2.5 px-8 py-4 bg-[#080808] text-white text-sm font-semibold rounded-xl hover:bg-[#1A1A1A] transition-colors">
      ...
      {/* ── Footer ── */}
      <div className="bg-[#080808] px-6 py-8 text-center">
        <Logo height={14} />
