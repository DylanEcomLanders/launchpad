  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-5 right-5 z-[60] flex items-center gap-2 px-4 py-2.5 rounded-full bg-[#1B1B1B] shadow-[0_4px_20px_rgba(0,0,0,0.25),0_2px_8px_rgba(0,0,0,0.15)] hover:bg-[#222222] hover:text-white hover:shadow-[0_6px_28px_rgba(0,0,0,0.3)] transition-all duration-200 group"
        title="Quick Links"
      >
        {open ? (
      ...
      {open && (
        <div
          ref={panelRef}
          className="fixed bottom-16 right-5 z-[60] w-[240px] bg-[#181818] rounded-xl shadow-[0_4px_24px_rgba(0,0,0,0.12),0_1px_4px_rgba(0,0,0,0.06)] border border-[#2A2A2A] overflow-hidden"
          style={{
        ...
        >
          ...
          <div className="px-3 py-2.5 border-b border-[#2A2A2A]">
            <p className="text-[10px] font-semibold uppercase tracking-wider text-[#9CA3AF]">Quick Links</p>
          </div>
          <div className="py-1.5">
            {links.map((link) => {
              const content = (
                <div className="flex items-center gap-3 px-3 py-2.5 hover:bg-[#0C0C0C] transition-colors cursor-pointer group/item">
                  <div
                  ...
                  <span className="text-sm text-[#C7C9CD] group-hover/item:text-[#E5E5EA] transition-colors">{link.label}</span>
                  {link.external && (
                    <svg className="size-3 text-[#C7C9CD] ml-auto shrink-0" viewBox="0 0 20 20" fill="currentColor">
