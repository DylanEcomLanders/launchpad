      ...
      {open && (
        ...
        >
          ...
          <div className="px-3 py-2.5 border-b border-border">
            <p className="text-[10px] font-semibold uppercase tracking-wider text-muted">Quick Links</p>
          </div>
          <div className="py-1.5">
            {links.map((link) => {
              const content = (
                <div className="flex items-center gap-3 px-3 py-2.5 hover:bg-background transition-colors cursor-pointer group/item">
                  <div
                  ...
                  <span className="text-sm text-muted group-hover/item:text-foreground transition-colors">{link.label}</span>
                  {link.external && (
                    <svg className="size-3 text-muted ml-auto shrink-0" viewBox="0 0 20 20" fill="currentColor">
