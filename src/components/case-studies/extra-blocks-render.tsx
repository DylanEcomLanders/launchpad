  ...
  return (
    <section className="px-6 md:px-10 pb-20">
      <div className="max-w-[1200px] mx-auto">
        {block.headline && (
          <h3 className="text-xl md:text-2xl font-semibold tracking-tight text-[#1B1B1B] mb-6">
            {block.headline}
          </h3>
        )}
        <ScreenshotGrid
  ...
  return (
    <section className="px-6 md:px-10 pb-16">
      <div className="max-w-[820px] mx-auto">
        {block.headline && (
          <h3 className="text-xl md:text-2xl font-semibold tracking-tight text-[#1B1B1B] mb-4">
            {block.headline}
          </h3>
        )}
