...
export function PhaseTimeline({
  ...
  return (
    <ol className={`relative ${compact ? "space-y-2.5" : "space-y-4"} before:absolute before:left-[5px] before:top-1.5 before:bottom-1.5 before:w-px before:bg-border`}>
      {spans.map((span, i) => {
        ...
        return (
          <li key={i} className="relative pl-6">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {span.isCurrent && <span className="text-[10px] text-muted">· in progress</span>}
            </div>
