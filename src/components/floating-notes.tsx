          ...
          <div className="flex-1 overflow-y-auto px-4 py-3 space-y-4 scrollbar-thin">
            ...
            {recording ? (
              <div className="border border-red-200 bg-red-50/30 rounded-lg p-3">
                ...
                {transcript && (
                  <p className="text-[11px] text-muted leading-relaxed bg-surface rounded p-2 border border-border">
                    {transcript}
                  </p>
                )}
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-1.5 py-2 border border-dashed border-border rounded-lg text-subtle hover:border-subtle hover:text-foreground transition-colors"
              >
            ...
            <div>
                ...
                {(currentNote?.actionItems || []).map((action) => (
                  ...
                  >
                    <input
                      ...
                      className="size-3.5 rounded border-border text-foreground focus:ring-0 mt-0.5 cursor-pointer"
                    />
                    <p
              ...
              <div className="flex items-center gap-1.5 mt-2">
                <input
                  ...
                  className="flex-1 text-xs px-2.5 py-1.5 border border-border rounded-md focus:outline-none focus:border-subtle placeholder:text-muted"
                />
                <button
                  onClick={addAction}
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full min-h-[80px] text-xs px-3 py-2 border border-border rounded-lg focus:outline-none focus:border-subtle placeholder:text-muted resize-y leading-relaxed"
              />
            </div>
            ...
            {currentNote?.rawTranscript && (
              <div>
                ...
                <div className="bg-background border border-border rounded-lg p-2.5">
                  <p className="text-[10px] text-muted leading-relaxed whitespace-pre-wrap">
                    {currentNote.rawTranscript}
                  </p>
                </div>
              </div>
